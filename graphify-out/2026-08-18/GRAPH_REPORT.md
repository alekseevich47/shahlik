...
## Corpus Check
- 29 files · ~1,336,678 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 385 nodes · 521 edges · 32 communities (23 shown, 9 thin omitted)
...
### Community 28 - "sort"
Cohesion: 0.33
Nodes (10): AdminPage(), applyGroupOrder(), criteriaOf(), GroupEditForm(), groupKeyOf(), groupProducts(), renumberCategory(), reorderArray() (+2 more)

### Community 29 - "App"
Cohesion: 0.50
Nodes (5): App(), loadCatalog(), normalizeAddon(), saveCatalog(), uid()
...
### Community 31 - "sort"
Cohesion: 0.22
Nodes (9): AForm(), Banners(), CategoryStrip(), HomePage(), isSauce(), needsChooser(), reorderOrdered(), SizeModal() (+1 more)
