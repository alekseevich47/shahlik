...
## Corpus Check
- 251 files · ~1,506,154 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1932 nodes · 4902 edges · 106 communities (99 shown, 7 thin omitted)
...
Cohesion: 0.09
Nodes (36): applyPricesJobKeys, asNumberList(), asStatusMap(), asStringList(), enqueueApplyPricesJob(), enqueueSyncJob(), fetchActiveSyncJobs(), fetchApplyPricesJobs() (+28 more)
...
### Community 24 - "cn"
Cohesion: 0.27
Nodes (11): useCategories(), useSettings(), settingsFallback(), useAddProduct(), groupProductsByCategory(), MobileHome(), Props, CategoryTiles() (+3 more)
...
### Community 27 - "cn.ts"
Cohesion: 0.23
Nodes (11): AxisLock, useAxisLockedHorizontalScroll(), clampScroll(), Edges, EdgeSide, prefersReducedMotion(), readEdges(), stepScrollLeft() (+3 more)
...
Cohesion: 0.08
Nodes (41): adjustBonus(), bonusKeys, BonusSettingsRecord, bulkSetBonusPercent(), claimPwaInstallBonus(), fetchBonusSettings(), fetchCustomerLedger(), LedgerRecord (+33 more)
...
Cohesion: 0.18
Nodes (18): badgeLabel(), PRODUCT_ASPECT_RATIO, minPrice(), isProductStopped(), useStoppedArticles(), Product, ProductCard(), ProductCardProps (+10 more)
...
Cohesion: 0.12
Nodes (22): OrderStatus, frontpadSettingsKeys, stoppedStockKeys, syncJobKeys, DEFAULT_STATUS_MAP, FrontpadSettings, FrontpadStockItem, PriceSource (+14 more)
...
Cohesion: 0.19
Nodes (12): useProducts(), CartPanel(), MODE_OPTIONS, CheckoutDialogState, useCheckoutDialogStore, HomePage(), Segmented(), SegmentedProps (+4 more)

### Community 64 - "loginWithOAuth"
Cohesion: 0.13
Nodes (19): BANNER_ASPECT_RATIO, canvasToBlob(), CropArea, cropImageToFile(), loadImage(), readImageSize(), ALLOWED, BannerImageField() (+11 more)

### Community 65 - "MobileHome.tsx"
Cohesion: 0.11
Nodes (34): useAddons(), useDeleteAddon(), AddonKind, useDeleteBanner(), useDeleteCategory(), useAdminProducts(), useDeleteProduct(), useToggleProductActive() (+26 more)
...
Cohesion: 0.16
Nodes (12): CartPanelState, useCartPanelStore, CartDock(), CatalogSection, DesktopHome(), Props, Options, useInView() (+4 more)
...
Cohesion: 0.11
Nodes (32): useExtras(), useSauces(), articleFor(), cartLineTitle(), compositionOf(), findSize(), findVariant(), hasMissingArticle() (+24 more)

### Community 73 - "category/api.ts"
Cohesion: 0.09
Nodes (28): useAccount(), acceptAuthToken(), fetchBonus(), submitReferral(), useProfileBonus(), isActiveOrderStatus(), OrderLineSnapshot, repeatOrderIntoCart() (+20 more)
...
Cohesion: 0.12
Nodes (32): useOrderJobs(), useResendOrder(), isFrontpadWarning(), Order, ORDER_STATUS_LABEL, cellDelta(), useFrontpadStock(), AdminPage() (+24 more)

### Community 76 - "getAccount"
Cohesion: 0.21
Nodes (15): SavedAddress, OrderAddressParts, formatAddressLine(), PaymentMethod, savedToParts(), useCheckout(), UseCheckoutArgs, AddressSection() (+7 more)

### Community 77 - "NutritionHint.tsx"
Cohesion: 0.17
Nodes (16): AdminLogin(), parseNonNeg(), SettingsSection(), TabId, TABS, Props, PhoneOnboardingProps, useCollectionRealtime() (+8 more)
...
Cohesion: 0.14
Nodes (14): useCreateProduct(), DEFAULT_NUTRITION, ProductCreateForm(), Props, CYR_MAP, slugFromName(), Chip(), ChipProps (+6 more)

### Community 84 - "mapFrontpadSettings"
Cohesion: 0.13
Nodes (11): ProductNutrition, MEAT_VARIANTS, NUTRITION_BY_CATEGORY, product(), products, shawarma(), SHAWARMA_SIZES, Spec (+3 more)
...
Cohesion: 0.21
Nodes (12): AccountAuth, AccountContext, AccountProvider(), isAbortError(), refreshAuth(), getClientAuthEpoch(), logout(), AppUser (+4 more)
...
Cohesion: 0.16
Nodes (12): orderKeys, AdminTopbar(), AdminTopbarProps, fetchNewOrdersCount(), newOrdersKey, adminCountKeys, AdminCounts, fetchAdminCounts() (+4 more)
...
Cohesion: 0.14
Nodes (22): useDuplicateProduct(), cellNutrition(), defaultNutritionFromSizes(), setCellNutrition(), DEFAULT_CRITERIA, MeatIcon, ProductBadge, ProductRating (+14 more)
...
Cohesion: 0.18
Nodes (16): checkPromo(), AppliedCoupon, calcCouponDiscount(), formatCouponValue(), CartTotals, ResolvedAddon, useCartTotals(), AddPayload (+8 more)
...
Cohesion: 0.09
Nodes (28): FreshStamp(), STAMP_GLYPHS, cn(), ConfirmDialog(), IconInput(), IconInputProps, IconTextarea(), IconTextareaProps (+20 more)
...
- **What is the exact relationship between `figma-make-app` and `Logo RGB`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `cn()` connect `ProductsSection` to `addon/api.ts`, `Sushi Catalog UI`, `Meal Add-ons UI`, `ProductEditor.tsx`, `cn`, `cn.ts`, `banner/api.ts`, `order/model.ts`, `MobileHome.tsx`, `pb.ts`, `CustomerDrawer.tsx`, `ProductCard.tsx`, `@radix-ui/react-slot`, `sonner`, `SettingsSection.tsx`, `banner-image-field.tsx`, `AddonForm.tsx`, `loginWithOAuth`, `MobileHome.tsx`, `CartLineRow.tsx`, `category/api.ts`, `files.ts`, `getAccount`, `NutritionHint.tsx`, `CategoryForm.tsx`, `VitrineScroll.tsx`, `NutritionHint.tsx`, `lenis`, `banner-image-field.tsx`?**
