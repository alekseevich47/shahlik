...
## Corpus Check
- 202 files · ~1,429,595 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1535 nodes · 4010 edges · 94 communities (83 shown, 11 thin omitted)
...
Cohesion: 0.06
Nodes (46): BadgeInput, badgeKeys, badgeMutations, BadgeRecord, fetchBadges(), mapBadge(), seedFallback(), useCreateBadge() (+38 more)

### Community 1 - "UI Layout Components"
Cohesion: 0.08
Nodes (38): adminReviewKeys, buildOrdersFilter(), createOrder(), CreateOrderInput, CreateReviewInput, fetchActiveResendJobs(), fetchAdminReviews(), fetchMyOrders() (+30 more)
...
Cohesion: 0.09
Nodes (32): AddonKind, useCreateProduct(), Props, Props, DEFAULT_NUTRITION, ProductCreateForm(), Props, PhoneOnboardingProps (+24 more)
...
Cohesion: 0.06
Nodes (66): OrderStatus, cellDelta(), applyPricesJobKeys, asNumberList(), asStatusMap(), asStringList(), enqueueApplyPricesJob(), enqueueSyncJob() (+58 more)
...
Cohesion: 0.18
Nodes (13): useDeleteAddon(), useCustomersPage(), loadDomMax(), SectionStub(), ADMIN_NAV, AdminNavItem, AdminRole, AdminSectionId (+5 more)
...
### Community 24 - "cn"
Cohesion: 0.13
Nodes (16): needsChooser(), SkuCell, Product, ProductBadge, ProductNutrition, ProductSize, ProductTag, ProductVariant (+8 more)
...
Cohesion: 0.16
Nodes (15): FrontpadJob, FrontpadJobKind, FrontpadJobStatus, isFrontpadWarning(), Order, ORDER_STATUS_FLOW, ORDER_STATUS_LABEL, ORDER_STATUS_SOURCE_LABEL (+7 more)

### Community 30 - "FloatingActions.tsx"
Cohesion: 0.36
Nodes (6): AdminLogin(), AdminTopbar(), fetchNewOrdersCount(), newOrdersKey, useAdminAuth(), queryClient

### Community 31 - "useCategories"
Cohesion: 0.12
Nodes (21): SumRow(), move(), Props, SortableList(), FreshStamp(), STAMP_GLYPHS, cn(), Modal() (+13 more)
...
Cohesion: 0.12
Nodes (20): useDeleteProduct(), useDuplicateProduct(), useUpdateProduct(), hasMissingArticle(), MeatIcon, RatingCriterion, product(), shawarma() (+12 more)
...
Cohesion: 0.25
Nodes (10): CategoryIcon(), Props, fetchSettings(), mapSettings(), useSettings(), settingsFallback(), AddressBar(), PromoBanner() (+2 more)

### Community 46 - "CustomerDrawer.tsx"
Cohesion: 0.14
Nodes (31): useCreateStaff(), KIND_FILTERS, STATUS_FILTERS, PriceRow, ROW_FILTERS, STATUS_LABEL, STATUS_FILTERS, ROLE_FILTERS (+23 more)
...
Cohesion: 0.15
Nodes (23): useProductBySlug(), fetchStoppedArticles(), isAddonStopped(), isSizeStopped(), isSkuStopped(), isVariantStopped(), stoppedArticlesKey, useFrontpadStockRealtime() (+15 more)

### Community 50 - "invalidateProductRatings"
Cohesion: 0.12
Nodes (31): accountCacheKey(), accountKeys, addAddress(), BonusResponse, fetchBonus(), getAccount(), normalizeClientPhone(), openYandexOAuthPopup() (+23 more)

### Community 51 - "ProductCard.tsx"
Cohesion: 0.18
Nodes (18): useCartTotals(), useCartStore, CartPanel(), MODE_OPTIONS, CartPromo(), CartTotals(), CheckoutDialogState, useCheckoutDialogStore (+10 more)

### Community 52 - "@radix-ui/react-slot"
Cohesion: 0.31
Nodes (11): useBadges(), badgeLabel(), PRODUCT_ASPECT_RATIO, minPrice(), isProductStopped(), ProductCard(), ProductCardProps, ProductCardCompact() (+3 more)
...
Cohesion: 0.17
Nodes (17): bannerFormData(), bannerKeys, bannerMutations, BannerNote, BannerRecord, CreateBannerInput, fetchBannerById(), mapBanner() (+9 more)
...
Cohesion: 0.15
Nodes (15): Addon, productKeys, cartLineTitle(), findSize(), findVariant(), addonFromCache(), CartTotals, productFromCache() (+7 more)

### Community 65 - "@radix-ui/react-dialog"
Cohesion: 0.13
Nodes (21): useCreateCategory(), useDeleteCategory(), useUpdateCategory(), useAdminReviews(), useDeleteReview(), useToggleReviewPublished(), useAdminProducts(), ProductEditorRoute() (+13 more)
...
Cohesion: 0.21
Nodes (14): OrderLineSnapshot, formatAddress(), LineRow(), OrderDetails(), Props, OrderHistoryRow(), formatAddress(), moneyRow() (+6 more)

### Community 73 - "category/api.ts"
Cohesion: 0.12
Nodes (24): isActiveOrderStatus(), formatAddressLine(), canUseStorage(), getLatestLocalOrderId(), isStoredOrder(), listLocalOrderIds(), load(), prune() (+16 more)
...
Cohesion: 0.24
Nodes (12): useCategories(), useProducts(), useAddProduct(), SearchDialog(), SearchDialogProps, groupProductsByCategory(), useCatalogScrollSpy(), DesktopHome() (+4 more)
...
## Knowledge Gaps
- **395 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+390 more)
...
- **What is the exact relationship between `figma-make-app` and `Logo RGB`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `cn()` connect `useCategories` to `addon/api.ts`, `Sushi Catalog UI`, `FloatingActions.tsx`, `ProductEditor.tsx`, `category/api.ts`, `StickyBar.tsx`, `order/model.ts`, `MobileHome.tsx`, `AdminSidebar.tsx`, `CustomerDrawer.tsx`, `HomePage.tsx`, `ProductCard.tsx`, `@radix-ui/react-slot`, `AdminPage.tsx`, `banner-image-field.tsx`, `@radix-ui/react-dialog`, `StickyBar.tsx`, `HeroBanner.tsx`, `category/api.ts`, `App.tsx`, `useCatalogScrollSpy.ts`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Button()` connect `CustomerDrawer.tsx` to `addon/api.ts`, `@radix-ui/react-dialog`, `order/api.ts`, `Sushi Catalog UI`, `MobileHome.tsx`, `category/api.ts`, `@radix-ui/react-slot`, `HomePage.tsx`, `ProductCard.tsx`, `@radix-ui/react-slot`, `FloatingActions.tsx`, `AdminPage.tsx`, `order/model.ts`, `FloatingActions.tsx`, `useCategories`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `formatPrice()` connect `HeroBanner.tsx` to `order/api.ts`, `order/model.ts`, `MobileHome.tsx`, `category/api.ts`, `CustomerDrawer.tsx`, `HomePage.tsx`, `invalidateProductRatings`, `useCatalogScrollSpy.ts`, `ProductCard.tsx`, `@radix-ui/react-slot`, `ProductEditor.tsx`, `FloatingActions.tsx`, `CategoryForm.tsx`, `AdminPage.tsx`, `order/model.ts`?**
