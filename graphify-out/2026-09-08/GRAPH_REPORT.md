...
## Corpus Check
- 250 files · ~1,502,710 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1888 nodes · 4845 edges · 107 communities (100 shown, 7 thin omitted)
...
Cohesion: 0.09
Nodes (33): adminReviewKeys, buildOrdersFilter(), createOrder(), CreateOrderInput, CreateReviewInput, fetchActiveResendJobs(), fetchAdminReviews(), fetchOrderById() (+25 more)
...
Cohesion: 0.15
Nodes (17): createBody(), updateBody(), bannerFormData(), bannerKeys, bannerMutations, BannerRecord, CreateBannerInput, fetchBannerById() (+9 more)
...
Cohesion: 0.10
Nodes (34): applyPricesJobKeys, asNumberList(), asStatusMap(), asStringList(), enqueueApplyPricesJob(), enqueueSyncJob(), fetchActiveSyncJobs(), fetchApplyPricesJobs() (+26 more)
...
### Community 24 - "cn"
Cohesion: 0.13
Nodes (22): frontpadSettingsKeys, settingsKeys, stoppedStockKeys, syncJobKeys, useUpdateSettings(), formatRemaining(), FrontpadPanel(), parseDigitCodes() (+14 more)
...
### Community 27 - "cn.ts"
Cohesion: 0.16
Nodes (13): BannerNote, BANNER_ASPECT_RATIO, Props, ALLOWED, BannerImageField(), formatMb(), Props, ALLOWED (+5 more)
...
Cohesion: 0.11
Nodes (25): addonKeys, addonMutations, AddonRecord, CreateAddonInput, fetchAddonById(), fetchAddons(), fetchAddonsByKind(), fetchExtras() (+17 more)
...
Cohesion: 0.06
Nodes (64): adjustBonus(), bonusKeys, BonusSettingsRecord, bulkSetBonusPercent(), claimPwaInstallBonus(), fetchBonusSettings(), fetchCustomerLedger(), fetchPublicBonusSettings() (+56 more)
...
Cohesion: 0.14
Nodes (22): useDeleteBanner(), useUpdateBanner(), useDeleteProduct(), useToggleProductActive(), useUpdateProduct(), hasMissingArticle(), BannerForm(), BannersSection() (+14 more)

### Community 47 - "order/model.ts"
Cohesion: 0.15
Nodes (14): Order, OrderLineSnapshot, Review, repeatOrderIntoCart(), useLiveOrder(), formatAddress(), LineRow(), OrderDetails() (+6 more)

### Community 48 - "@radix-ui/react-slot"
Cohesion: 0.16
Nodes (21): badgeLabel(), useProducts(), PRODUCT_ASPECT_RATIO, minPrice(), needsChooser(), fetchStoppedArticles(), isProductStopped(), stoppedArticlesKey (+13 more)
...
Cohesion: 0.14
Nodes (10): AppliedCoupon, DeliveryMode, AddPayload, CartAddon, CartItem, CartState, EMPTY_ADDRESS_PARTS, CheckoutModeToggle() (+2 more)
...
### Community 53 - "sonner"
Cohesion: 0.20
Nodes (13): useDeleteCategory(), useAdminProducts(), loadDomMax(), ProductEditorRoute(), SectionStub(), ADMIN_NAV, AdminNavItem, AdminRole (+5 more)
...
Cohesion: 0.10
Nodes (19): BonusEarnHint(), BonusEarnHintProps, CartTotalsProps, SumRow(), BonusSpendBlock(), CheckoutDialogProps, PAYMENT_OPTIONS, BADGES (+11 more)
...
Cohesion: 0.16
Nodes (20): productKeys, cartLineTitle(), compositionOf(), findSize(), findVariant(), nutritionForPortion(), nutritionOf(), parseWeightGrams() (+12 more)
...
Cohesion: 0.18
Nodes (15): cellDelta(), planAllCashPrices(), stockPriceMap, AdminPage(), CashPricesPanel(), flattenPlans(), formatSigned(), PriceRow (+7 more)
...
Cohesion: 0.14
Nodes (25): useActivityLogsPage(), useDeleteAddon(), useCoupons(), useDeleteCoupon(), COLUMNS, LogsSection(), AddonsSection(), KIND_FILTERS (+17 more)
...
Cohesion: 0.10
Nodes (22): fetchBonus(), submitReferral(), useProfileBonus(), BonusHistoryReason(), BonusHistoryRow, BONUS_REASON_LABEL, fetchMyOrders(), useMyOrders() (+14 more)
...
Cohesion: 0.15
Nodes (24): useOrder(), useOrderJobs(), useResendOrder(), useUpdateOrderStatus(), isFrontpadWarning(), ORDER_STATUS_FLOW, ORDER_STATUS_SOURCE_LABEL, DashboardSection() (+16 more)
...
Cohesion: 0.19
Nodes (11): useCreateProduct(), AdminLogin(), DEFAULT_NUTRITION, ProductCreateForm(), Props, PhoneOnboardingProps, CYR_MAP, slugFromName() (+3 more)
...
Cohesion: 0.12
Nodes (24): CategoryId, cellNutrition(), defaultNutritionFromSizes(), setCellNutrition(), criterionScore(), DEFAULT_CRITERIA, MeatIcon, ProductBadge (+16 more)
...
Cohesion: 0.12
Nodes (12): KnownCategoryId, ProductNutrition, MEAT_VARIANTS, NUTRITION_BY_CATEGORY, product(), products, shawarma(), SHAWARMA_SIZES (+4 more)
...
Cohesion: 0.14
Nodes (22): checkPromo(), formatCouponValue(), useFrontpadStockRealtime(), useCartTotals(), useCartStore, CartPanel(), MODE_OPTIONS, CartPromo() (+14 more)
...
Cohesion: 0.22
Nodes (9): DEFAULT_STATUS_MAP, FrontpadSettings, FrontpadStockItem, PriceSource, Settings, BADGE_LABEL, ORDER_RULES, resolveBadgeLabel() (+1 more)

### Community 110 - "select.tsx"
Cohesion: 0.16
Nodes (12): FrontpadJob, FrontpadJobKind, FrontpadJobStatus, ORDER_STATUS_LABEL, OrderAddressParts, OrderLineAddon, OrderStatus, AddressSectionProps (+4 more)
...
Cohesion: 0.11
Nodes (24): ProductModal(), ProductViewProps, AddonRow(), Props, FreshStamp(), STAMP_GLYPHS, cn(), ConfirmDialog() (+16 more)
