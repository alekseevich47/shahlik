# Graph Report - shahlik  (2026-08-07)

## Corpus Check
- 28 files · ~103,104 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 328 nodes · 414 edges · 28 communities (19 shown, 9 thin omitted)
...
Cohesion: 0.05
Nodes (22): Addon, ADDONS0, AdminPage(), App(), Banner, Banners(), BANNERS0, C (+14 more)

### Community 1 - "UI Layout Components"
Cohesion: 0.10
Nodes (20): pillBtn, Props, Props, Props, Props, defaultAddons, defaultBanners, defaultCategories (+12 more)
