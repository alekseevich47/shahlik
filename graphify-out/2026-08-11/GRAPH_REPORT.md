# Graph Report - shahlik  (2026-08-11)

## Corpus Check
- 28 files · ~105,023 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 334 nodes · 425 edges · 31 communities (20 shown, 11 thin omitted)
...
5. `CartItem` - 9 edges
6. `Ваш заказ checkout screen` - 9 edges
7. `С этим товаром выбирают` - 9 edges
8. `sort()` - 8 edges
9. `Props` - 8 edges
10. `Page` - 8 edges
...
Cohesion: 0.05
Nodes (16): Addon, ADDONS0, Banner, BANNERS0, C, CartItem, Category, CATS0 (+8 more)

### Community 1 - "UI Layout Components"
Cohesion: 0.10
Nodes (21): pillBtn, Props, Props, Props, Props, defaultAddons, defaultBanners, defaultCategories (+13 more)
...
### Community 28 - "sort"
Cohesion: 0.36
Nodes (8): AdminPage(), Banners(), CategoryStrip(), groupProducts(), HomePage(), moveItem(), sort(), sortVariants()
