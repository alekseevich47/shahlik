...
Cohesion: 0.16
Nodes (13): mapRating(), normalizeDistribution(), RatingCriterion, CriterionHint(), formatGrams(), NutritionHint(), useIsDesktop(), useIsWide() (+5 more)
...
Cohesion: 0.15
Nodes (21): useDuplicateProduct(), cellNutrition(), defaultNutritionFromSizes(), setCellNutrition(), criterionScore(), criterionStars(), MeatIcon, ProductNutrition (+13 more)
...
Cohesion: 0.13
Nodes (29): useExtras(), useSauces(), cartLineTitle(), compositionOf(), findSize(), findVariant(), hasMissingArticle(), nutritionForPortion() (+21 more)
