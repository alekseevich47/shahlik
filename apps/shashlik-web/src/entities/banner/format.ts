...
export const BANNER_HEIGHT = 460
...
/** Мягкий минимум исходника до обрезки (экспорт 1680×460 всё равно возможен, но будет апскейл). */
export const BANNER_MIN_SOURCE_WIDTH = 840
export const BANNER_MIN_SOURCE_HEIGHT = 230
